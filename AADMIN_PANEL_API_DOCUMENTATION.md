...
11. **Reports & Analytics** (Generate reports: `/admin/reports`)
12. **Settings & Configuration** (Rate configuration, penalties: `/admin/settings`)
...
**Last Updated:** January 2025  
**Version:** 1.1.0 (Added duplicate `/api` fix documentation)
